...
class fourmodel_teacher(nn.Module):
    def __init__(self, ):
        super(fourmodel_teacher, self).__init__()

        self.backbonet = shunted_b()
        self.backboner = shunted_b()
    ...
    def forward(self, r, d):
        ...
        # return s4_out, s3_out, s2_out, s1_out, out_r, out_d, add1_r, add1_d, s1, s2, s3, s4, r4, d4, r3, d3, r2, d2, r1, d1
